...
namespace EcommerceStandardsDocuments
{
    ...
    ///                     "purchaseOrderKeyPurchaseUnitID": "EA",
    ///                     "purchaseOrderUnitName": "EACH",
    ///                     "taxes":
    ///                     [
    ///                         {
    ///                             "keyTaxcodeID":"456",
    ...
    /// </example>
    [DataContract]
    public class ESDocumentOrderSale : ESDocument
    {
        /// <summary>List of sales order records</summary>
        [JsonProperty(Order = -4)]
        [DataMember]
        public ESDRecordOrderSale[] dataRecords;

        /// <summary>Constructor</summary>
        /// <param name="resultStatus">status of obtaining the sales order data</param>
        /// <param name="message">message to accompany the result status</param>
        /// <param name="salesOrderRecords">list of sales order records</param>
        /// <param name="configs">A list of key value pairs that contain additional information about the document.</param>
        public ESDocumentOrderSale(int resultStatus, string message, ESDRecordOrderSale[] salesOrderRecords, Dictionary<string, string> configs)
        {
            ...
            {
                this.totalDataRecords = salesOrderRecords.Length;
            }
        }
    }
}