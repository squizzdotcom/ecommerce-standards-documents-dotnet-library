...
{
    /// <summary>Details of a surcharge assigned to an order record within a Ecommerce Standards Document</summary>
    [DataContract]
    public class ESDRecordOrderSurcharge
    {
        ...
        /// <summary>Key of the surcharge record that the order line surcharge record is linked to.</summary>
        [DataMember]
