...
{
    /// <summary>Ecommerce Standards Record that holds data for a single line in a supplier's invoice.</summary>
    [DataContract]
    public class ESDRecordSupplierInvoiceLine
    {
        ...
        /// <summary>number of the line in original purchase order associated to the supplier's invoice line</summary>
        [DataMember(EmitDefaultValue = false)]
        public string purchaseOrderLineNumber { get; set; }
	
        /// <summary>Code of the line in the supplier's customer invoice associated to the line</summary>
        [DataMember(EmitDefaultValue = false)]
        public string customerInvoiceLineCode { get; set; }

        /// <summary>number of the line in the supplier's customer invoice associated to the invoice line</summary>
        [DataMember(EmitDefaultValue = false)]
        public string customerInvoiceLineNumber { get; set; }
	
	    /// <summary>Code of the line in the supplier's sales order associated to the invoice line</summary>
        [DataMember(EmitDefaultValue = false)]
        public string salesOrderLineCode { get; set; }

        /// <summary>number of the line in the supplier's sales order associated to the invoice line</summary>
        [DataMember(EmitDefaultValue = false)]
