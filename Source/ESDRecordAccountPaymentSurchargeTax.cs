...
{
    /// <summary>Details of a tax assigned to a customer/supplier payment surcharge within a Ecommerce Standards Document</summary>
    [DataContract]
    public class ESDRecordAccountPaymentSurchargeTax
    {
        /// <summary>Key of the taxcode record that the payment surcharge tax record is linked to.</summary>
        ...
        /// <summary>Numeric amount as a percentage rate that the taxcode applies to. Eg. if set to 10, then a 10% tax will be applied on top of the account payment surcharge price.</summary>
        [DataMember(EmitDefaultValue = false)]
