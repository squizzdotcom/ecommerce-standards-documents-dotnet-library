...
{
    /// <summary>Ecommerce Standard Record holding data for a customer account order line</summary>
    [DataContract]
    public class ESDRecordCustomerAccountEnquiryOrderSaleLine
    {
        /// <summary>Key that allows the customer account sales order line record to be uniquely identified and linked to.</summary>
        [DataMember]
        public string keyOrderSaleLineID { get; set; }
