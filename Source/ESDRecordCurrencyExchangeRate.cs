...
{
    /// <summary>Ecommerce Standards Record that holds data for a single currency exchange rate that reflects the cost of purchasing one currency from another. These rates may be used to inflience the price of selling or buying goods and services between states or countries.</summary>
    [DataContract]
