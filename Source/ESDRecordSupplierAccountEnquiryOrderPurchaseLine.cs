...
{
    /// <summary>Ecommerce Standard Record holding data for a supplier account order line</summary>
    [DataContract]
    public class ESDRecordSupplierAccountEnquiryOrderPurchaseLine
    {
        /// <summary>Key that allows the supplier account purchase order line record to be uniquely identified and linked to.</summary>
        [DataMember]
        public string keyOrderPurchaseLineID { get; set; }
        ...
        /// <summary>Defines the type of data that the line represents. Set it to one of the constants prefixed with RECORD_LINE_TYPE_ in the ESDocumentConstants class</summary>
        [DataMember(EmitDefaultValue = false)]
