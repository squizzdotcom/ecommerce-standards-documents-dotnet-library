...
{
    /// <summary>Ecommerce Standard Record holding data for a customer account quote line. The line stores information about a single type of product, goods or service, and the pricing quoted to purchase the item</summary>
    [DataContract]
    public class ESDRecordCustomerAccountEnquiryQuoteLine
    {
        /// <summary>Key that allows the customer account quote line record to be uniquely identified and linked to.</summary>
        [DataMember]
        public string keyQuoteLineID { get; set; }
        ...
        /// <summary>United Nations Standard Products and Service Code. Stores a standard code defined by the United Nations for classifying objects.</summary>
        [DataMember(EmitDefaultValue = false)]
        public string UNSPSC { get; set; }
        /// <summary>Quantity quoted for the line.</summary>
        [DataMember(EmitDefaultValue = false)]
