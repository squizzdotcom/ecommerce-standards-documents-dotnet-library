...
namespace EcommerceStandardsDocuments
{
    ...
    public class ESDRecordCustomerInvoiceLine
    {
        ...
        [Obsolete("supplierInvoiceDownloadCode is deprecated, please use supplierInvoiceAssetCode instead.")]
        [DataMember(EmitDefaultValue = false)]
        ...
        /// <summary>code of the asset in the customer's supplier invoice, that stores the code of the customer's asset</summary>
        [DataMember(EmitDefaultValue = false)]
        public string supplierInvoiceAssetCode { get; set; }
