...
namespace EcommerceStandardsDocuments
{
    ...
    public class ESDRecordCustomerAccountEnquiryBackOrder
    {
        ...
        /// <summary>Text, number or code that the customer uses to identify the back order record. This could be the customer's purchase order order, supplier invoice code, or an other identifier.</summary>
        [DataMember(EmitDefaultValue = false)]
        ...
        /// <summary>Name of the contact person associated to the billing address set for the order.</summary>
        [DataMember(EmitDefaultValue = false)]
        public string billingContact { get; set; }
        /// <summary>Name of the organisation associated to the billing address set for the order.</summary>
        [DataMember(EmitDefaultValue = false)]
