...
{
    /// <summary>Ecommerce Standards record that contains the data of a single address associated to a supplier account.</summary>
    [DataContract]
    public class ESDRecordSupplierAccountAddress
    {
        /// <summary>Key that allows the supplier account address record to be uniquely identified and linked to.</summary>
        [DataMember]
        public string keyAddressID { get; set; }

        /// <summary>Key of the supplier account record that the address record is linked to.</summary>
        [DataMember(EmitDefaultValue = false)]
        public string keySupplierAccountID { get; set; }

        /// <summary>Description of the supplier account address. This may be used as a label to help a person identify with the address.</summary>
        [DataMember(EmitDefaultValue = false)]
        ...
        /// 'Y'-Yes
        /// If 'Y' then indicates that the address is the primary address assigned to the supplier account. Typically a primary address would be the account's billing address.</summary>
        [DataMember(EmitDefaultValue = false)]
        public string isPrimary { get; set; }

        /// <summary>Either 'N'-No or 
        /// 'Y'-Yes
        /// If 'Y' then indicates that the address may be used by the supplier account where it delivers goods from.</summary>
        [DataMember(EmitDefaultValue = false)]
