...
{
    /// <summary>Ecommerce Standards Record that holds data for a single attribute associated with products. Attributes define the fields that can have values set for products.</summary>
    [DataContract]
    public class ESDRecordProductAttribute
    {
        /// <summary>Key that allows the product attribute record to be uniquely identified and linked to.</summary>
        [DataMember]
        public string keyProductAttributeID { get; set; }
        /// <summary>name of the product attribute</summary>
