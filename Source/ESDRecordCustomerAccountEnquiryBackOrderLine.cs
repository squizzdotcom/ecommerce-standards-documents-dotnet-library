...
{
    /// <summary>Ecommerce Standard Record holding data for a customer account back order line</summary>
    [DataContract]
    public class ESDRecordCustomerAccountEnquiryBackOrderLine
    {
        /// <summary>Key that allows the customer account back order line record to be uniquely identified and linked to.</summary>
        [DataMember]
        public string keyBackOrderLineID { get; set; }
