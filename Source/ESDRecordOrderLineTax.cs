...
{
    /// <summary>Details of a tax assigned to a order line within a Ecommerce Standards Document</summary>
    [DataContract]
    public class ESDRecordOrderLineTax
    {
        /// <summary>Key of the taxcode record that the order line tax record is linked to.</summary>
        ...
        /// <summary>Numeric amount as a percentage rate that the taxcode applies to. Eg. if set to 10, then a 10% tax will be applied on top of the order line price.</summary>
        [DataMember(EmitDefaultValue = false)]
