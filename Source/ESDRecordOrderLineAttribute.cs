...
{
    /// <summary>Ecommerce Standards Record that holds data for a single attribute and value within a order line. This allows any additional fields and field values to be set with the order line.</summary>
    [DataContract]
    public class ESDRecordOrderLineAttribute
    {
        /// <summary>Key of the order attribute record</summary>
        [DataMember]
